...
--
-- Client: localhost
-- Généré le: Sam 11 Octobre 2014 à 13:49
...
--
-- Structure de la table `allocation_reports`
--
...
--
-- Contenu de la table `allocation_reports`
--
...
--
-- Structure de la table `archive_budgets`
--
...
--
-- Structure de la table `archive_budget_expenses`
--
...
--
-- Structure de la table `archive_budget_incomes`
--
...
--
-- Structure de la table `archive_claims`
--
...
--
-- Structure de la table `archive_clubs`
--
...
--
-- Structure de la table `archive_clubusers`
--
...
--
-- Structure de la table `archive_deposits`
--
...
--
-- Structure de la table `archive_expenditure_accounts`
--
...
--
-- Structure de la table `archive_requests`
--
...
--
-- Structure de la table `archive_reserve_accounts`
--
...
--
-- Structure de la table `archive_users`
--
...
--
-- Structure de la table `claim_times`
--
...
--
-- Contenu de la table `claim_times`
--
...
--
-- Structure de la table `ereceipts`
--
...
(98, 'fcp', '0.00', '0.00', '2014-08-26 09:21:46', '2014-10-11 12:47:11'),
...
--
-- Structure de la table `funds_transfers`
--
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `receiptsize` int(11) DEFAULT NULL,
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `receiptupdatedat` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Structure de la table `reserve_limits`
--
...
--
-- Contenu de la table `reserve_limits`
--
...
--
-- Structure de la table `reserve_withdrawals`
--
...
('jinqyi.lee.2012', NULL, '2014-08-12 06:40:04', '2014-10-09 14:42:45', 'S1234567Z', 'jinqyi.lee.2012@sis.smu.edu.sg', '$2a$10$uQ/67L231N7cdQfQ4jPILulx/gOd/Rt/8dKMNIx4T5QtWWr4KjpZC', NULL, NULL, NULL, 13, '2014-10-09 14:42:45', '2014-09-15 14:07:32', '127.0.0.1', '127.0.0.1', NULL, '2014-08-12 06:40:23', '2014-08-12 06:40:04', NULL, 'jinq', '273109831'),
...
('trecia.koh.2012', NULL, '2014-08-12 06:37:51', '2014-10-11 04:48:25', 'S1234567Z', 'trecia.koh.2012@sis.smu.edu.sg', '$2a$10$BpLTvaJXIkpi1tmC1OfKQ.3ccbi3qAyYPJthZ1drIKRMfXIlgBMny', NULL, NULL, NULL, 47, '2014-10-11 04:48:25', '2014-10-11 04:35:05', '127.0.0.1', '127.0.0.1', NULL, '2014-08-12 06:38:08', '2014-08-12 06:37:51', NULL, 'ying', '730710310'),
